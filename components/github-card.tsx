...
export function GithubCard() {
  ...
  return (
    <BentoCard className="rounded-2xl border border-white/10 bg-zinc-950/40 backdrop-blur-md p-6 sm:p-8 shadow-2xl relative overflow-hidden md:col-span-2" delay={0.5}>
